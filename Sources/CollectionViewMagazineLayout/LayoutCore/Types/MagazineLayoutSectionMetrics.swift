...
struct MagazineLayoutSectionMetrics: Equatable {
    ...
    -> MagazineLayoutSectionMetrics
  {
    return MagazineLayoutSectionMetrics(
      ...
      horizontalSpacing: MagazineLayout.Defaults.horizontalSpacing,
      verticalSpacing: MagazineLayout.Defaults.verticalSpacing,
      sectionInsets: MagazineLayout.Defaults.sectionInsets,
      itemInsets: MagazineLayout.Defaults.itemInsets)
  }
