...
public final class MagazineLayout: UICollectionViewLayout {
  ...
  public var itemSizeMode: MagazineLayoutItemSizeMode = Defaults.itemSizeMode

  public var headerVisibilityMode: MagazineLayoutHeaderVisibilityMode = Defaults.headerVisibilityMode

  public var footerVisibilityMode: MagazineLayoutFooterVisibilityMode = Defaults.footerVisibilityMode

  public var backgroundVisibilityMode: MagazineLayoutBackgroundVisibilityMode = Defaults.backgroundVisibilityMode

  public var horizontalSpacing: CGFloat = Defaults.horizontalSpacing

  public var verticalSpacing: CGFloat = Defaults.verticalSpacing

  public var sectionInsets: UIEdgeInsets = Defaults.sectionInsets

  public var itemInsets: UIEdgeInsets = Defaults.itemInsets
  ...
  public init(flipsHorizontallyInOppositeLayoutDirection: Bool) {
    ...
    -> UICollectionViewLayoutInvalidationContext
  {
    ...
    default:
      assertionFailure("`MagazineLayout` supports only cells and decoration views")
    }
  ...
  private func sizeModeForItem(at indexPath: IndexPath) -> MagazineLayoutItemSizeMode {
    guard let delegateMagazineLayout = delegateMagazineLayout else {
      return MagazineLayoutItemSizeMode(
        widthMode: MagazineLayout.Defaults.itemSizeMode.widthMode,
        heightMode: .static(height: MagazineLayout.Defaults.itemHeight))
    }
  ...
  private func initialItemHeight(from itemSizeMode: MagazineLayoutItemSizeMode) -> CGFloat {
    ...
    case .dynamic, .dynamicAndStretchToTallestItemInRow:
      return MagazineLayout.Defaults.itemHeight
    }
  }
  ...
  {
    guard let delegateMagazineLayout = delegateMagazineLayout else {
      return MagazineLayout.Defaults.headerVisibilityMode
    }
  ...
  {
    guard let delegateMagazineLayout = delegateMagazineLayout else {
      return MagazineLayout.Defaults.footerVisibilityMode
    }
  ...
  {
    guard let delegateMagazineLayout = delegateMagazineLayout else {
      return MagazineLayout.Defaults.backgroundVisibilityMode
    }
    ...
    -> CGFloat
  {
    ...
    case let .static(staticHeight):
      return staticHeight
    case .dynamic:
      return MagazineLayout.Defaults.headerHeight
    }
  }
    ...
    -> CGFloat
  {
    ...
    case let .static(staticHeight):
      return staticHeight
    case .dynamic:
      return MagazineLayout.Defaults.footerHeight
    }
  }
